...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Central Garden', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'share purchase advice on garden decor, garden tools, garden bed and other garden essentials', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-red-theta.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'garden decor,garden tools,garden bed,raised beds,rail planters,planters,container,garden accessories,pots,nursery pots,vertical & Wall planters,vertical planters,Wall planters,hanging planters', // 网站关键词 英文逗号隔开
